...
@export var number_card_max_faces: int = 3  # Maximum number of face cards applied to a number card.
...
@export var require_all_caravans: bool = false  # Require a player must sell all their caravans to win
